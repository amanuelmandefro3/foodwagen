...
import { createFoodSchema, type CreateFoodFormData } from "@/lib/validations"
...
export function AddMealModal({ open, onOpenChange }: AddMealModalProps) {
  const { createMeal, creating, createError, clearCreateError } = useMeals()
  ...
  const validateForm = (): CreateFoodFormData | null => {
    setErrors({})
    clearCreateError()
    ...
    const result = createFoodSchema.safeParse(dataToValidate)
              ...
              >
                {foodImagePreview ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Click to upload food image</p>
              ...
              >
                {logoImagePreview ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Click to upload restaurant logo</p>
